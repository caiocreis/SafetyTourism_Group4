...
namespace SafetyTourism_Group4.Models
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(PlatformContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("nifID,name,address,email,phoneNumber")] Employee employee)
        {
