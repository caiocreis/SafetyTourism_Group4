...
namespace SafetyTourism_Group4.Models
{
    public class DestinationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("destinationID,countryName,cityName")] Destination destination)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("destinationID,countryName,cityName")] Destination destination)
        {
